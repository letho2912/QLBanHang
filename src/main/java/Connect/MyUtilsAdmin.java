...
public class MyUtilsAdmin {
 ...
 // Lưu trữ Connection vào attribute của request.
    ...
    public static void storeLoginedUser(HttpSession session, UserAdmin loginedAdmin) {
        // Trên JSP có thể truy cập thông qua ${loginedUser}
        session.setAttribute("loginedAdmin", loginedAdmin);
    }
 
    // Lấy thông tin người dùng lưu trữ trong Session.
    public static UserAdmin getLoginedUser(HttpSession session) {
        UserAdmin loginedAdmin = (UserAdmin) session.getAttribute("loginedAdmin");
        return loginedAdmin;
    }
