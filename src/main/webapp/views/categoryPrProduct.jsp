			...
			<div class="title_new" style="margin-bottom: 10px;">
				...
				<span style="float: right;">
					<form action="#" method="get">
						<label for="cars" style="margin-right: 5px;font-weight: 300;font-size: 17px;">Sắp xếp:  </label> <select
							style="width: 150px; height: 30px;" name="cars" id="cars">
							...
							<option value="cunhat">Sản phẩm cũ nhất</option>
						</select>
					</form>
				</span>
				</div>
			<div class="productNew">
				<c:forEach items="${productPrCategory}" var="list">
					<div class="productEx">
